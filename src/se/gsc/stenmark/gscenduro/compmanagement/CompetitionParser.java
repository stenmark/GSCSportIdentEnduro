...
public class CompetitionParser implements Serializable{
	...
	public void parseCompetition(String competitionString) throws IOException{
		...
		BufferedReader bufReader = new BufferedReader(new StringReader(competitionString));
		String line = null;
		int lineNumber = 0;
			...
			if (line.length() > 0)
			{
				...
				if (type.equals("competitionName")){															
					...
					{							
						...
						mStatus += "Name = " + Name + " cardNumber = " + cardNumber + "\n";
						
						Card cardObject = new Card();
						cardObject.cardNumber = Integer.parseInt(cardNumber);
